# 使用VGG的notop层，在top层用flatten ——> fc1(4096) ——> fc2(4096) ——> Dense(9)，fromscratch训练，但是用的SGD优化器
...
history = []
checkpointer = ModelCheckpoint(filepath='/home/mayixuan/mal-visual/checkpoint/Malimg/Malimg-vgg16-SGD-%depochs-fromscratch-2.h5' %(num_epochs),
...
model.compile(optimizer=keras.optimizers.SGD(lr=5e-5, momentum=0.9), loss='categorical_crossentropy', metrics=['accuracy'])
...
# plot the graph
save_path="/home/mayixuan/mal-visual/experiment-image/Malimg/Malimg-vgg16-SGD-300epochs-fromscratch-2/"
