...
epoch = 500
save_parameters = '/home/mayixuan/mal-visual/checkpoint/Malimg/Malimg-vgg16-SGD-500epochs-transfer-0.8.h5'
X_train_drop = 0.2
Experiment_results = "/home/mayixuan/mal-visual/experiment-image/Malimg/Malimg-vgg16-SGD-500epochs-transfer-0.8/"
# batchsize = 64
...
filename = '/home/mayixuan/mal-visual/extracted-features/Malimg-vgg16features.npy'
...
for i in range(kfold):
    ...
    top_model.compile(optimizer=keras.optimizers.SGD(lr=5e-5, momentum=0.9), loss='categorical_crossentropy',
                      metrics=['accuracy'])

    top_model.set_weights(init_weights)
    # 这里初始化了
