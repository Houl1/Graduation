...
for i in range(len(list_fams)):
    ...
    len1 = len(glob.glob('*.png'))  # assuming the images are stored as 'JPG'
    no_imgs.append(len1)
    os.chdir('..')
...
history = []
checkpointer = ModelCheckpoint(filepath='/home/mayixuan/mal-visual/checkpoint/Malimg/Malimg-resnet50-avgpool-Adam-100epochs-fromscratch.h5',
...
# plot the graph
save_path="/home/mayixuan/mal-visual/experiment-image/Malimg/Malimg-resnet50-avgpool-Adam-100epochs-fromscratch/"
