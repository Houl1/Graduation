...
imagedir = "BIG-9-family"

epoch = 500
save_parameters = '/home/mayixuan/mal-visual/checkpoint/BIG-15/BIG15-inceptionv3-Adam-500epochs-transfer-0.8.h5'
X_train_drop = 0.2  # 即分出来的测试集test
Experiment_results = "/home/mayixuan/mal-visual/experiment-image/BIG-15/BIG15-inceptionv3-Adam-500epochs-transfer-0.8/"
...
for i in range(len(list_fams)):
    ...
    len1 = len(glob.glob('*.JPG'))  # 取百分之x，样本数向下取整
    no_imgs.append(len1)
    os.chdir('..')
...
filename = '/home/mayixuan/mal-visual/extracted-features/BIG15-inceptionv3features.npy'
